...
export default function Slider({ value, className, onValueChange, ...props }: RadixSlider.SliderProps) {
	...
	return (
		...
		>
			...
			<RadixSlider.Thumb
				...
				aria-label="Volume"
			>
				{value?.[0] != null && (isHovered || isInteracting) && (
					<NumberFlow
						willChange
						value={value[0]}
						isolate
						...
						className="absolute bottom-8 left-1/2 -translate-x-1/2 text-lg font-semibold drop-shadow-2xl"
					/>
				)}
			</RadixSlider.Thumb>
		</RadixSlider.Root>
